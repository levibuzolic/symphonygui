...
- [x] Add local SQLite store with schema bootstrap and seeded starter board
- [x] Register a built-in `local` tracker adapter and auto-promote it when no external tracker is configured
